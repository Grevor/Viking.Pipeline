...
namespace Viking.Pipeline
{
    ...
    public sealed partial class ReactionPipelineStage<TInput1, TInput2, TInput3> : IPipelineStage
    {
		/// <summary>
		...
		public ReactionPipelineStage(
			...
			this(GetDefaultName(input1, input2, input3), reaction, input1, input2, input3, reactImmediately) 
		{ }
