...
namespace Viking.Pipeline
{
    ...
    public sealed partial class ReactionPipelineStage<TInput1, TInput2, TInput3, TInput4, TInput5, TInput6, TInput7, TInput8> : IPipelineStage
    {
		/// <summary>
		...
		public ReactionPipelineStage(
			...
			this(GetDefaultName(input1, input2, input3, input4, input5, input6, input7, input8), reaction, input1, input2, input3, input4, input5, input6, input7, input8, reactImmediately) 
		{ }
		...
		public ReactionPipelineStage(
			...
			IPipelineStage<TInput7> input7,
			IPipelineStage<TInput8> input8) :
			this(name, reaction, input1, input2, input3, input4, input5, input6, input7, input8, true) 
		{ }
