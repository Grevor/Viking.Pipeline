...
namespace Viking.Pipeline.CodeGenerator
{
    class Program
    {
        static void Main()
        {
            ...
            Generate("DispatcherReactionTemplate.txt", Environment.CurrentDirectory + @"\..\..\..\..\..\Wpf\Viking.Pipeline.Wpf\Generated\Dispatcher\DispatcherReactionPipelineStage$Number$.cs", 8);
        }
