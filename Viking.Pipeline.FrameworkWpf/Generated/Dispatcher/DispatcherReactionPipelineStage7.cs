...
{
    public partial class DispatcherReactionPipelineStage<TInput1, TInput2, TInput3, TInput4, TInput5, TInput6, TInput7> : IPipelineStage
    {
		...
		public DispatcherReactionPipelineStage(
			...
			this(GetDefaultName(input1, input2, input3, input4, input5, input6, input7), reaction, DispatcherUtilities.DefaultDispatcher, input1, input2, input3, input4, input5, input6, input7, reactImmediately) 
		{ }
		...
		public DispatcherReactionPipelineStage(
			...
			IPipelineStage<TInput6> input6,
			IPipelineStage<TInput7> input7) :
			this(name, reaction, DispatcherUtilities.DefaultDispatcher, input1, input2, input3, input4, input5, input6, input7, true) 
		{ }
			...
			bool reactImmediately)
		{
			...
			if (reactImmediately)
				InvokeReaction(Input1.GetValue(), Input2.GetValue(), Input3.GetValue(), Input4.GetValue(), Input5.GetValue(), Input6.GetValue(), Input7.GetValue());
		}
		...
		private void InvokeReaction(TInput1 input1, TInput2 input2, TInput3 input3, TInput4 input4, TInput5 input5, TInput6 input6, TInput7 input7)
		{
			Dispatcher.Invoke(() => Reaction.Invoke(input1, input2, input3, input4, input5, input6, input7));
		}
