...
{
    public class ChangeableOperationPipelineStage<TInput1, TInput2, TInput3, TInput4, TOutput> : IPipelineStage<TOutput>
    {
		...
		public IPipelineStage<Func<TInput1, TInput2, TInput3, TInput4, TOutput>> OperationStage { get; }
		...
		public TOutput GetValue() => OperationStage.GetValue().Invoke(Input1.GetValue(), Input2.GetValue(), Input3.GetValue(), Input4.GetValue());
	...
	{
		public static ChangeableOperationPipelineStage<TInput1, TInput2, TInput3, TInput4, TOutput> Create<TInput1, TInput2, TInput3, TInput4, TOutput>(
			string name, 
			IPipelineStage<Func<TInput1, TInput2, TInput3, TInput4, TOutput>> operation, 
			IPipelineStage<TInput1> input1,
			IPipelineStage<TInput2> input2,
			IPipelineStage<TInput3> input3,
			IPipelineStage<TInput4> input4)
			=> new ChangeableOperationPipelineStage<TInput1, TInput2, TInput3, TInput4, TOutput>(
				name,
				operation,
