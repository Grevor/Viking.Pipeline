...
{
    public class ChangeableOperationPipelineStage<TInput1, TInput2, TInput3, TInput4, TInput5, TInput6, TOutput> : IPipelineStage<TOutput>
    {
		...
		public IPipelineStage<Func<TInput1, TInput2, TInput3, TInput4, TInput5, TInput6, TOutput>> OperationStage { get; }
		...
		public TOutput GetValue() => OperationStage.GetValue().Invoke(Input1.GetValue(), Input2.GetValue(), Input3.GetValue(), Input4.GetValue(), Input5.GetValue(), Input6.GetValue());
	...
	{
		public static ChangeableOperationPipelineStage<TInput1, TInput2, TInput3, TInput4, TInput5, TInput6, TOutput> Create<TInput1, TInput2, TInput3, TInput4, TInput5, TInput6, TOutput>(
			string name, 
			IPipelineStage<Func<TInput1, TInput2, TInput3, TInput4, TInput5, TInput6, TOutput>> operation, 
			IPipelineStage<TInput1> input1,
			IPipelineStage<TInput2> input2,
			...
			IPipelineStage<TInput5> input5,
			IPipelineStage<TInput6> input6)
			=> new ChangeableOperationPipelineStage<TInput1, TInput2, TInput3, TInput4, TInput5, TInput6, TOutput>(
				name,
				operation,
