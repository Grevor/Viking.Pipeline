...
namespace Viking.Pipeline
{
    public class OperationPipelineStage<TInput1, TInput2, TInput3, TInput4, TInput5, TInput6, TOutput> : IPipelineStage<TOutput>
    {
		...
		public Func<TInput1, TInput2, TInput3, TInput4, TInput5, TInput6, TOutput> Operation { get; }
		...
		public TOutput GetValue() => Operation(Input1.GetValue(), Input2.GetValue(), Input3.GetValue(), Input4.GetValue(), Input5.GetValue(), Input6.GetValue());
